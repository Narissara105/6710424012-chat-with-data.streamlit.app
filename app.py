...
def summarize_as_analyst(answer: str) -> str:
    summary_prompt = (
        "คุณเป็นนักวิเคราะห์ข้อมูลที่เชี่ยวชาญ สรุปคำตอบให้สั้นที่สุด โดยแสดงเพียงค่าคำตอบเป็นตัวเลขหรือข้อความที่เกี่ยวข้องโดยตรงเท่านั้น ห้ามอธิบายเพิ่มเติม ห้ามใส่คำว่า 'ผลลัพธ์ดิบ:'
